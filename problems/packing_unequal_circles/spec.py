"""ISTH spec for CO-Bench task: 'Packing unequal circles' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_packing_unequal_circles", _CONFIG_PATH)
