"""ISTH spec for CO-Bench task: 'Packing unequal rectangles and squares area' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_packing_unequal_rectangles_and_squares_area", _CONFIG_PATH)
