"""ISTH spec for CO-Bench task: 'Travelling salesman problem' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_travelling_salesman_problem", _CONFIG_PATH)
