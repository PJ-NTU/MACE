"""ISTH spec for CO-Bench task: 'Common due date scheduling' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_common_due_date_scheduling", _CONFIG_PATH)
