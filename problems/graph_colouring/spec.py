"""ISTH spec for CO-Bench task: 'Graph colouring' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_graph_colouring", _CONFIG_PATH)
