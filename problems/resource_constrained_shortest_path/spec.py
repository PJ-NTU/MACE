"""ISTH spec for CO-Bench task: 'Resource constrained shortest path' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_resource_constrained_shortest_path", _CONFIG_PATH)
