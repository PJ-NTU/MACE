"""ISTH spec for CO-Bench task: 'Capacitated warehouse location' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_capacitated_warehouse_location", _CONFIG_PATH)
