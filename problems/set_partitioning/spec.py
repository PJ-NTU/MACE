"""ISTH spec for CO-Bench task: 'Set partitioning' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_set_partitioning", _CONFIG_PATH)
