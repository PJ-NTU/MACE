"""ISTH spec for CO-Bench task: 'Uncapacitated warehouse location' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_uncapacitated_warehouse_location", _CONFIG_PATH)
