"""ISTH spec for CO-Bench task: 'Generalised assignment problem' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_generalised_assignment_problem", _CONFIG_PATH)
