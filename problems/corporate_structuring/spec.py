"""ISTH spec for CO-Bench task: 'Corporate structuring' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_corporate_structuring", _CONFIG_PATH)
