"""ISTH spec for CO-Bench task: 'Multidimensional knapsack problem' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_multidimensional_knapsack_problem", _CONFIG_PATH)
