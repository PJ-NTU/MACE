"""ISTH spec for CO-Bench task: 'Hybrid Reentrant Shop Scheduling' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_hybrid_reentrant_shop_scheduling", _CONFIG_PATH)
