"""ISTH spec for CO-Bench task: 'Job shop scheduling' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_job_shop_scheduling", _CONFIG_PATH)
