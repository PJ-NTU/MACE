"""ISTH spec for CO-Bench task: 'Vehicle routing_ period routing' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_vehicle_routing_period_routing", _CONFIG_PATH)
