"""ISTH spec for CO-Bench task: 'p-median - uncapacitated' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_p_median_uncapacitated", _CONFIG_PATH)
