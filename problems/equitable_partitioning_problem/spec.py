"""ISTH spec for CO-Bench task: 'Equitable partitioning problem' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_equitable_partitioning_problem", _CONFIG_PATH)
