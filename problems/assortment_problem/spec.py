"""ISTH spec for CO-Bench task: 'Assortment problem' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_assortment_problem", _CONFIG_PATH)
