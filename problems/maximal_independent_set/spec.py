"""ISTH spec for CO-Bench task: 'Maximal independent set' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_maximal_independent_set", _CONFIG_PATH)
