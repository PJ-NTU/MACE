"""ISTH spec for CO-Bench task: 'Constrained non-guillotine cutting' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_constrained_non_guillotine_cutting", _CONFIG_PATH)
