"""ISTH spec for CO-Bench task: 'Set covering' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_set_covering", _CONFIG_PATH)
