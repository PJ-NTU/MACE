"""ISTH spec for CO-Bench task: 'Aircraft landing' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_aircraft_landing", _CONFIG_PATH)
