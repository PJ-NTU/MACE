"""ISTH spec for CO-Bench task: 'Assignment problem' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_assignment_problem", _CONFIG_PATH)
