"""ISTH spec for CO-Bench task: 'Unconstrained guillotine cutting' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_unconstrained_guillotine_cutting", _CONFIG_PATH)
