"""ISTH spec for CO-Bench task: 'Euclidean Steiner problem' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_euclidean_steiner_problem", _CONFIG_PATH)
