"""ISTH spec for CO-Bench task: 'Flow shop scheduling' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_flow_shop_scheduling", _CONFIG_PATH)
