"""ISTH spec for CO-Bench task: 'Open shop scheduling' (auto-generated)."""
...
_mod_spec = importlib.util.spec_from_file_location("_cobench_cfg_open_shop_scheduling", _CONFIG_PATH)
